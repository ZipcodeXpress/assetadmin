...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $organizationNumber = array('#', '##');
    ...
    protected static $streetAddressFormats = array(
        ...
        '{{streetName}} {{buildingNumber}}',
        '{{streetName}} {{buildingNumber}}',
        '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, ap. {{organizationNumber}}',
        '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, et. {{floor}}, ap. {{organizationNumber}}',
        '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, sc. {{blockSegment}}, et. {{floor}}, ap. {{organizationNumber}}',
    );
    ...
    public static function organizationNumber()
    {
        return static::numerify(static::randomElement(static::$organizationNumber));
    }
