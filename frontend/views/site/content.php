                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <label class="mb-1">Sizes & Secondary color</label>
                                <p class="text-muted font-13">
                                    Add an attribute <code>
            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-1 mt-3 font-weight-bold text-muted">Single Select</p>
                                <p class="text-muted font-13">
                            ...
                            <div class="col-md-6">
                                <p class="mb-1 mt-3 font-weight-bold text-muted">Multiple Select</p>
                                <p class="text-muted font-13">
                                    Select2 can take a regular select box like this...
                                </p>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p class="mb-1 mt-3 font-weight-medium text-muted">Default usage</p>
                                <p class="text-muted font-13">
                                ...
                                <div>
                                    <p class="mb-1 mt-4 font-weight-medium text-muted">Threshold value</p>
                                    <p class="text-muted font-13">
                                ...
                                <div>
                                    <p class="mb-1 mt-4 font-weight-medium text-muted">All the options</p>
                            ...
                            <div class="col-md-6">
                                <div class="">
                                    ...
                                    <p class="mb-1 mt-3 font-weight-medium text-muted">Position</p>
                                    <p class="text-muted font-13">
                                    ...
                                    <div>
                                        <p class="mb-1 mt-4 font-weight-medium text-muted">Textareas</p>
                                        <p class="text-muted font-13">
