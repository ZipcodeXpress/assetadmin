...
use frontend\common\CommonStatus;
    ...
    $('.update_member').click(function () {
        ...
        swal({ 
       	 ...
       	 $.ajax({
             ...
             type: 'post',
             data: {"id":<?=$model->member_id?>,"email":$("#member-email").val(),"phone":$("#member-phone").val(),"status":$("#member-status").val(),"c_status":$("#member-c_status").val(),"is_email_verified":$("#member-is_email_verified").val(),"is_profile_completed":$("#member-is_profile_completed").val(),"has_credit_card":$("#member-has_credit_card").val(),"cabinet_id":$("#member-cabinet_id").val(),"service_mode":$("#member-service_mode").val()},
