...
class Member extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['salt', 'register_time', 'lastlogin_time', 'status', 'c_status', 'is_email_verified', 'is_profile_completed', 'has_credit_card', 'cabinet_id','cardcode'], 'integer'],
            [['service_mode'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'is_profile_completed' => 'Profile Completed?',
