...
/**
 * MemberorganizationSearch represents the model behind the search form about `backend\models\Memberorganization`.
 :*/
class MemberorganizationSearch extends Memberorganization
{
	...
	$query->andFilterWhere(['like', 'last_name', $this->last_name]);
        ...
        $query->andFilterWhere(['=', 'o_member_organization.organization_id', $this->organization_id]);
        //$query->andFilterWhere(['=', 'o_member_organization.unit_id', $this->unit_name]);
