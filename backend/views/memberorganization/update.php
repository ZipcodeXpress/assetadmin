    ...
    <div class="user-create">
        <div class="ibox-content">
           ...
           <div class="memberorganization-form">
                ...
                <?= $form->field($model->organization, 'organization_name')->textInput(['readonly'=>true]) ?>
         <!--  <?= $form->field($model->unit, 'unit_id')->dropDownList(Memberorganization::getUnitNameByOrganizationId($model->organization_id))->label("Business Unit") ?>
