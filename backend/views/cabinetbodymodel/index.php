...
/* @var $searchModel app\models\CabinetbodymodelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Locker Body Model';
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-sm-3">
                    <p>
                         <?= Html::a('Create Body Model', ['create'], ['class' => 'btn btn-primary']) ?>
                    </p>
                     <?php 
                                ...
                                ['class' => 'yii\grid\ActionColumn',
                                    ...
                                    'buttons' => [
                                        ...
                                        return Html::a('<i class="fa fa-edit"></i> Edit',
                                            Url::toRoute(['cabinetbodymodel/update','id'=>$key]),
                                            [
...
//                                             Url::toRoute(['cabinetbodymodel/delete','id'=>$key]),
//                                             [
...
<script>
    $('.delete').click(function () { 
        ...
        swal({
       	 ...
       	 $.ajax({
             url: "index.php?r=cabinetbodymodel/delete",
             type: 'post',
