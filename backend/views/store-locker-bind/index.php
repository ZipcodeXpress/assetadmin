        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="col-sm-3">
                    <p>
                       <?= Html::a('Create Store Lockers Bind', ['create'], ['class' => 'btn btn-primary']) ?>
                    </p>
                    ...
                    <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'value' => function ($model) { return $model->store->firstname.' '.$model->store->lastname; },
                                ],
                                ...
                                ['class' => 'yii\grid\ActionColumn',
                                    ...
                                    'buttons' => [
                                        ...
                                        return Html::a('<i class="fa fa-edit"></i> Edit',
                                            Url::toRoute(['store-locker-bind/update','id'=>$key,'oc_store_id'=>$model->oc_store_id,'cabinet_id'=>$model->cabinet_id]),
                                            [
                                        ...
                                        return Html::button('Delete',['class'=>'btn btn-default btn-xs delete','data-oc_store_id'=>$model->oc_store_id,'data-cabinetid'=>$model->cabinet_id]);
                                        },
//                                         'delete' => function($url, $model, $key){
...
<script>
    $('.delete').click(function () { 
        ...
        swal({
       	 ...
       	 $.ajax({
             url: "index.php?r=store-locker-bind/delete",
             type: 'post',
             data: {"oc_store_id":self.data('oc_store_id'),"cabinet_id":self.data('cabinetid') },
