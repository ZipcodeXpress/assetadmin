                ...
                <div class="ibox-content">
                   ...
                   <?php 
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ['class' => 'yii\grid\SerialColumn', 'headerOptions' => ['height' => '40','width'=>'40'],],
                            ['label'=>'Organization',  'attribute' => 'organization_name',  'value' => 'organization.organization_name' ],
                            //'unit_id',
                            'unit_name',
                            //'organization_id',
                               ...
                               'header' => 'Action',
                                ...
                                'buttons' => [
                                    ...
                                    return Html::a('<i class="fa fa-edit"></i> Edit',
                                        Url::toRoute(['unit/update','id'=>$key]),
                                        [
...
//                                         Url::toRoute(['unit/delete','id'=>$key]),
//                                         [
