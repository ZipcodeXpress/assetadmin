...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
			...
			'options' => ['style' => 'font-size:15px; word-wrap: break-word;'],
                        'columns' => [
                            ['class' => 'yii\grid\SerialColumn','headerOptions' => ['width' => '5%'],],
                            ['label'=>'Member ID',  'attribute' => 'member_id',  'value' => 'member_id' ,'headerOptions' => ['width' => '6%'] ],
                            ['label'=>'First name' ,  'attribute' => 'first_name','value' => 'memberprofile.first_name','headerOptions' => ['width' => '8%']],
			    ['label'=>'Last name' ,  'attribute' => 'last_name','value' => 'memberprofile.last_name','headerOptions' => ['width' => '8%']],
	       		    ['label'=>'Member Email',  'attribute' => 'email',  'value' => 'member.email' ,'headerOptions' => ['width' => '15%'],],
                            [
                                'label'=>'Member Phone',  
                                'attribute' => 'phone', 
                            ...
                            ['class' => 'yii\grid\ActionColumn',
                                ...
                                'buttons' => [
                                            ...
                                            if($model->approve_status==1)
                                            {
                                                if($model->status==3)
                                                {
                                                    return Html::a('<i class="fa fa-edit"></i>  Recovery',
                                                        Url::toRoute(['apmrmember/approve','member_id'=>$model->member_id,'organization_id'=>$model->organization_id,'cancel_time'=>$model->cancel_time]),
                                                        [
                                        ...
                                        return Html::a('<i class="fa fa-edit"></i> Update',
                                            Url::toRoute(['apmrmember/update','member_id'=>$model->member_id,'organization_id'=>$model->organization_id,'cancel_time'=>$model->cancel_time]),
                                            [
