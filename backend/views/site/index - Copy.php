                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <li><a class="J_menuItem" href="<?= Url::toRoute(['user/update','id'=>Yii::$app->user->identity->getId(),'act'=>'updateProfile'])?>">Admin Profile</a>
                                </li>
                                <li class="divider"></li>
                                <li><a href="<?=Url::toRoute('site/logout')?>">Exit</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                    <div class="page-tabs-content">
                        <a href="javascript:;" class="active J_menuTab" data-id="index_v1.html">Zippora Report</a>
                    </div>
                </nav>
                <button class="roll-nav roll-right J_tabRight"><i class="fa fa-forward"></i>
                </button>
                <div class="btn-group roll-nav roll-right">
                    <button class="dropdown J_tabClose" data-toggle="dropdown">Action<span class="caret"></span>

                    </button>
                    <ul role="menu" class="dropdown-menu dropdown-menu-right">
                        <li class="J_tabShowActive"><a>Show Active Tab</a>
                        </li>
                        <li class="divider"></li>
                        <li class="J_tabCloseAll"><a>Close All Tabs</a>
                        </li>
                        <li class="J_tabCloseOther"><a>Close Others</a>
                        </li>
                    </ul>
                </div>
                <a href="<?=Url::toRoute('site/logout')?>" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> Exit</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<?= Url::toRoute('report/zippora')?>" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
                <div class="pull-right">&copy; 2017 <a href="http://www.zipcodexpress.com/" target="_blank">ZipcodeXpress</a>
                </div>
            </div>
        </div>
        <!--右侧部分结束-->
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane active">
                        <div class="sidebar-title">
                            <h3> <i class="fa fa-comments-o"></i> Theme Configuration</h3>
                            <small><i class="fa fa-tim"></i> Settings will be saved at local，It will be active next time you login。</small>
                        </div>
                        <div class="skin-setttings">
                            <div class="title">Theme</div>
                            <div class="setings-item">
                                <span>Left Hidden</span>
                                <div class="switch">
